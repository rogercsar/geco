    ...
    <div className="min-h-screen bg-secondary-50">
      ...
      <main className="lg:ml-64 container mx-auto px-4 pt-6 pb-10">
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-8 max-w-2xl">
          <h1 className="text-2xl font-bold text-secondary-900 mb-3">Pagamento pendente</h1>
          <p className="text-secondary-700 mb-6">Seu pagamento está sendo processado. Você será notificado quando for aprovado.</p>
